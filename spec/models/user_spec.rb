...
describe User do
  ...
  describe "when email format is invalid" do
    it "should be invalid" do
      addresses = %w[user@ex,com user_at_ex.org us.er@ex. 
			user@ex_ample.com user@ex+ample.com]
  ...
  describe "when email format is valid" do
    it "should be valid" do
      addresses = %w[user@ex.COM u_SE-r@e.x.org us.er@ex.jp 
			us+er@ex.cn]
  ...
  describe "micropost associations" do
    ...
    it "should be in the right order, newer first" do
      #also tests that user.microposts is an array
